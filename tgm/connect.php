 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme Charity
...
function charity_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			...
			'source'             => get_template_directory() . '/tgm/plugins/timber-library.1.7.1.zip', // The plugin source.
			'required'           => true, // If false, the plugin is only 'recommended' instead of required.
			'version'            => '1.7.1', // E.g. 1.0.0. If set, the active plugin must be this version or higher. If the plugin version is higher than the plugin version installed, the user will be notified to update the plugin.
		...
		array(
			...
			'required'           => true, // If false, the plugin is only 'recommended' instead of required.
			'version'            => '5.6.4', // E.g. 1.0.0. If set, the active plugin must be this version or higher. If the plugin version is higher than the plugin version installed, the user will be notified to update the plugin.
			'force_activation'   => true, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch.
			'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins.
			'external_url'       => '', // If set, overrides default API URL and points to an external URL.
			'is_callable'        => '', // If set, this callable will be be checked for availability to determine if a plugin is active.
		...
		array(
			'name'               => 'qTranslateX', // The plugin name.
			'slug'               => 'qtranslate-x', // The plugin slug (typically the folder name).
			'source'             => get_template_directory() . '/tgm/plugins/qtranslate-x.3.4.6.8.zip', // The plugin source.
			'required'           => true, // If false, the plugin is only 'recommended' instead of required.
		...
		array(
			...
			'source'             => get_template_directory() . '/tgm/plugins/cyr3lat.3.5.zip', // The plugin source.
			'required'           => true, // If false, the plugin is only 'recommended' instead of required.
	 ...
	 */
	$config = array(
		'id'           => 'charity',                 // Unique ID for hashing notices for multiple instances of TGMPA.
		...
		/*
		'strings'      => array(
			'page_title'                      => __( 'Install Required Plugins', 'charity' ),
			'menu_title'                      => __( 'Install Plugins', 'charity' ),
			/* translators: %s: plugin name. * /
			'installing'                      => __( 'Installing Plugin: %s', 'charity' ),
			/* translators: %s: plugin name. * /
			'updating'                        => __( 'Updating Plugin: %s', 'charity' ),
			'oops'                            => __( 'Something went wrong with the plugin API.', 'charity' ),
			...
			'return'                          => __( 'Return to Required Plugins Installer', 'charity' ),
			'plugin_activated'                => __( 'Plugin activated successfully.', 'charity' ),
			'activated_successfully'          => __( 'The following plugin was activated successfully:', 'charity' ),
			/* translators: 1: plugin name. * /
			'plugin_already_active'           => __( 'No action taken. Plugin %1$s was already active.', 'charity' ),
			/* translators: 1: plugin name. * /
			'plugin_needs_higher_version'     => __( 'Plugin not activated. A higher version of %s is needed for this theme. Please update the plugin.', 'charity' ),
			/* translators: 1: dashboard link. * /
			'complete'                        => __( 'All plugins installed and activated successfully. %1$s', 'charity' ),
			'dismiss'                         => __( 'Dismiss this notice', 'charity' ),
			'notice_cannot_install_activate'  => __( 'There are one or more required or recommended plugins to install, update or activate.', 'charity' ),
			'contact_admin'                   => __( 'Please contact the administrator of this site for help.', 'charity' ),
